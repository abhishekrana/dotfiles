...
Plug 'ervandew/supertab'																			" Cycle through code-completion suggestions
" Use asynchronous deoplete-jedi for code completion and jedi-vim (with code completion disabled) for documentation and code traversal in python
Plug 'davidhalter/jedi-vim'																			" Uses supertab. Uses jedi autocompletion library (pip install jedi). Libraries are cached. Supports virtual env
...
Plug 'zchee/deoplete-jedi'																			" Requires deoplete, jedi, python-client
" C/C++
...
"Plug 'python-mode/python-mode'	" Conflicts with jedi-vim
" Plug 'python-mode/python-mode', { 'branch': 'develop' }		" Conflicts with jedi-vim
