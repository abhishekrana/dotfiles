return {
  ...
  config = function()
    -- VS Code-like diff tints, tuned for Solarized Light. On other flavors let the
    -- colorscheme provide its own diff highlights.
    if vim.g.colors_name == "solarized" and vim.o.background == "light" then
